/**
 * Registry Services - Application Layer Export
 *
...
/**
 * Registry Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for registry domain.
 */
