/**
 * Benefits Services - Application Layer Export
 *
...
/**
 * Benefits Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for benefits domain.
 */
